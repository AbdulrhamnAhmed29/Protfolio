...
console.log(counter);
  ...
  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/AbdulrhamnAhmed29" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/abdulrhman-aahmed-828a94354/" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:abdulrhmanaagmed4@gmail.com" }
  ];
  ...
  const tabContent = {
    ...
    professional: "Dedicated Frontend Developer with professional training at ElevoPath. I specialize in building scalable architectures and writing clean, maintainable code. My focus is on delivering high-performance interfaces that add immediate value to development teams and help businesses grow.",
    approach: "I advocate for Clean Code, Modular Architecture, and User-Centered Design. My development process is built on Scalable Logic and Performance Optimization, ensuring that every project is not just functional, but maintainable and ready for future growth."
  };
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-2xl transition-all duration-500 group-hover:border-primary/40 group-hover:scale-105 md:group-hover:scale-110 relative">
                      <img src="/logo.png" alt="Abdulrhman" className="w-full h-full object-cover" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Abdulrhman Ahmed</h2>
                    <p className="text-primary text-base sm:text-lg font-semibold mb-3 sm:mb-4">Front End Developer</p>
                  </div>
                </div>
