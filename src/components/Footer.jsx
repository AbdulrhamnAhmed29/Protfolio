...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/abdulrhman-aahmed-828a94354/", label: "LinkedIn" },
    { icon: <Github size={18} />, href: "https://github.com/AbdulrhamnAhmed29", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "abdulrhmanaahmed4@gmail.com", href: "abdulrhmanaahmed4@gmail.com" },
    { icon: <Phone size={16} />, text: "01116045357", href: "tel:+201116045357" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Abdulrhman</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Frontend Developer focused on building scalable, high-performance web applications with clean and maintainable code.        </p>
          ...
          >
            <div>
              <p>© {currentYear} Abdulrhman. All rights reserved.</p>
            </div>
